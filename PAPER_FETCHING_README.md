...
- LLM 会重新给出研究问题价值、方法新意、系统价值、证据强度四个分项，并标注兴趣适配：`target_network_autonomy`、`general_ai_system`、`out_of_scope_domain` 或 `unclear`；同时根据作者区、机构脚注、邮箱域名、致谢、项目页或摘要上下文提取发表单位线索，无法确认时必须说明“单位线索不足”。
